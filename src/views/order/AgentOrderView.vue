<template>
  <div class="agent-order-view nav-bar">
...
import { queryLogistics, queryAgentOrderDetail } from "@/services/order";
...
export default defineComponent({
  ...
  methods: {
    ...
    async getOrderDetail() {
      const res = await queryAgentOrderDetail({ id: this.orderId });
